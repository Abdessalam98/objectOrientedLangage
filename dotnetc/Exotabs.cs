...
namespace dotnetc
{
    ...
    class ExoTabs
    {
        ...
        // Seconde méthode pour créer un tableau de 10 cases avec 0
        ...
        // Note Random r = new Random(DateTime.Now.Milisecond); seed
        ...
        {
            Dictionary<string, float> annuaire = new Dictionary<string, float>();
            annuaire.Add("Personne1", 15);
            annuaire.Add("Personne2", 18);
            annuaire.Add("Personne3", 25);
            foreach (KeyValuePair<string, float> k in annuaire)
